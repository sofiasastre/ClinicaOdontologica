window.addEventListener('load', function(){
    ...
    formulario.addEventListener('submit', function(event){
        ...
        fetch(url, settings)
            ...
            .then(data => {
                let successAlert = '<div class="alert alert-success alert-dismissible">'+'<button type="button" class="close" data-dismiss="alert">&times;</button>'+'<strong></strong>Paciente agregado </div>'
